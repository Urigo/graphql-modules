...
<MDXTabs namespace={`di/providers/class`}>
<MDXTab label="Expression">
...
<MDXTabs namespace={`di/providers/value`}>
<MDXTab label="Expression">
...
<MDXTabs namespace={`di/providers/factory`}>
<MDXTab label="Expression">
...
<MDXTabs namespace={`di/providers/service`}>
<MDXTab label="Resolver">
...
<MDXTabs namespace={`di/providers/injection-token`}>
<MDXTab label="Resolver">
...
<MDXTabs namespace={`di/providers/global`}>
<MDXTab label="Definition">
