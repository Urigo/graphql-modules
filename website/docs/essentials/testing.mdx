...
<MDXTabs namespace={`essentials/testing/replace-extensions`}>
<MDXTab label="my-module.spec.ts">
...
<MDXTabs namespace={`essentials/testing/extend-sdl`}>
<MDXTab label="my-module.spec.ts">
...
<MDXTabs namespace={`essentials/testing/inherit-sdl`}>
<MDXTab label="my-module.spec.ts">
...
<MDXTabs namespace={`essentials/testing/testInjector`}>
<MDXTab label="logger.spec.ts">
...
<MDXTabs namespace={`essentials/testing/middlewares`}>
<MDXTab label="my-module.spec.ts">
