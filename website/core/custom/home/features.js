...
module.exports = (props) => (
  <div {...props} className={`Features ${props.className || ''}`}>
    <List className="_features-list">
      <Feature src={apiFeat} title="Reusable Modules" description="Modules are defined by their GraphQL schema (Schema first design). They're completely independent and can be shared between apps." />
